...
@pytest.fixture
def use_case_under_test(order_gateway_mock, user_gateway_mock, send_sms_notification_gateway_mock, send_email_notification_gateway_mock):
    return AddOrderUsecase(order_gateway_mock, user_gateway_mock, send_sms_notification_gateway_mock, send_email_notification_gateway_mock)
...
def test_add_order_usecase_returns_new_order_id(notify_user_usecase_mock, order_gateway_mock, use_case_under_test):
    order_gateway_mock.add_order.return_value = {"id": "12345"}
    notify_user_usecase_mock.return_value = {
        "status": "SMS sent"
    }
...
@mock.patch.object(NotifyUserUsecase, "__call__")
def test_add_order_usecase_calls_notify_user_usecase(notify_user_usecase_mock, order_gateway_mock, user_gateway_mock, use_case_under_test):
    user = User(id="12345")
    ...
    notify_user_usecase_mock.assert_called_once_with(user=user, sequencing_type="whole-exome-sequencing", order_id="432432")