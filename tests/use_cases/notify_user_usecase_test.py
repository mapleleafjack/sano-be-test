...
@pytest.fixture
def usecase_under_test(
    sms_notification_service_gateway_mock, email_notification_service_gateway_mock
):
...
def test_usecase_returns_phone_gateway_error_when_sms_gateway_returns_error_when_order_type_is_dna_whole_exome_sequencing(
    usecase_under_test, sms_notification_service_gateway_mock
):
...
def test_usecase_returns_email_gateway_error_when_email_gateway_returns_error_when_order_type_is_not_dna_whole_exome_sequencing(
    usecase_under_test, email_notification_service_gateway_mock
):
...
def test_usecase_returns_sms_gateway_response_when_order_type_is_dna_whole_exome_sequencing(
    usecase_under_test, sms_notification_service_gateway_mock
):
...
def test_usecase_returns_email_gateway_response_when_order_type_is_not_dna_whole_exome_sequencing(
    usecase_under_test, email_notification_service_gateway_mock
):
    email_notification_service_gateway_mock.notify.return_value = {
        "status": "Email sent"
