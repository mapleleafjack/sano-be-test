...
def test_get_user_by_id_usecase_returns_error_when_no_id_provided(usecase_under_test, add_user_gateway_mock):
    response = usecase_under_test(None)

    assert response == {"errors": ["NOT_PROVIDED"]}

def test_get_user_by_id_usecase_calls_gateway(usecase_under_test, add_user_gateway_mock):
...
def test_get_user_by_id_returns_error_when_gateway_returns_error(usecase_under_test, add_user_gateway_mock):
