...
def test_add_user_usecase_returns_error_if_user_not_provided(usecase_under_test):
    response = usecase_under_test.add_user(
...
def test_add_user_usecase_returns_error_when_both_phone_number_and_email_are_not_provided(
    usecase_under_test,
):
    response = usecase_under_test.add_user(
        name="John Doe",
...
def test_add_user_usecase_calls_gateway_function(
    usecase_under_test, add_user_gateway_mock
):
    usecase_under_test.add_user(
        name="John Doe",
...
def test_add_user_usecase_returns_error_when_gateway_returns_error(
    usecase_under_test, add_user_gateway_mock
):
