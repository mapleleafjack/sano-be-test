...
class AddOrderUsecase():
    def __init__(self, order_gateway, user_gateway, sms_notification_service_gateway, email_notification_service_gateway):
    ...
    def __call__(self, user_id, sequencing_type, shipping_info):
        ...
        notification_response = notify_user_usecase(user=user, sequencing_type=sequencing_type, order_id=add_order_response["id"])

        return {"order_id": add_order_response["id"], "notification_response": notification_response}